...
<div class="sdg-list alignwide">
  ...
  <div class="box-container alignwide">
    <div class="box">
      ...
      <div class="box-1" id="box1"><?php get_field('ei_koyhyytta1');?></div>
      <div class="box-2" id="box1"><?php get_field('ei_koyhyytta2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box2"><?php get_field('ei_nalkaa1');?></div>
      <div class="box-2" id="box2"><?php get_field('ei_nalkaa2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box3"><?php get_field('terveytta_ja_hyvinvointia1');?></div>
      <div class="box-2" id="box3"><?php get_field('terveytta_ja_hyvinvointia2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box4"><?php get_field('hyva_koulutus1');?></div>
      <div class="box-2" id="box4"><?php get_field('hyva_koulutus2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box5"><?php get_field('sukupuolten_tasaarvo1');?></div>
      <div class="box-2" id="box5"><?php get_field('sukupuolten_tasaarvo2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box6"><?php get_field('puhdas_vesi_ja_sanitaatio1');?></div>
      <div class="box-2" id="box6"><?php get_field('puhdas_vesi_ja_sanitaatio2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box7"><?php get_field('edullista_ja_puhdasta_energiaa1');?></div>
      <div class="box-2" id="box7"><?php get_field('edullista_ja_puhdasta_energiaa2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box8"><?php get_field('ihmisarvoista_tyota_ja_talouskasvua1');?></div>
      <div class="box-2" id="box8"><?php get_field('ihmisarvoista_tyota_ja_talouskasvua2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box9"><?php get_field('kestavaa_teollisuutta1');?></div>
      <div class="box-2" id="box9"><?php get_field('kestavaa_teollisuutta2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box10"><?php get_field('eriarvoisuuden_vahentaminen1');?></div>
      <div class="box-2" id="box10"><?php get_field('eriarvoisuuden_vahentaminen2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box11"><?php get_field('kestavat_kaupungit1');?></div>
      <div class="box-2" id="box11"><?php get_field('kestavat_kaupungit2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box12"><?php get_field('vastuullista_kuluttamista1');?></div>
      <div class="box-2" id="box12"><?php get_field('vastuullista_kuluttamista2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box13"><?php get_field('ilmastotekoja1');?></div>
      <div class="box-2" id="box13"><?php get_field('ilmastotekoja2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box14"><?php get_field('vedenalainen_elama1');?></div>
      <div class="box-2" id="box14"><?php get_field('vedenalainen_elama2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box15"><?php get_field('maanpaallinen_elama1');?></div>
      <div class="box-2" id="box15"><?php get_field('maanpaallinen_elama2');?></div>
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box16"><?php get_field('rauha_ja_oikeudenmukaisuus1');?></div>
      <div class="box-2" id="box16"><?php get_field('rauha_ja_oikeudenmukaisuus2');?></div>    
    </div>
    <div class="box">
      <div class="sdg-title">
      ...
      <div class="box-1" id="box17"><?php get_field('yhteistyo_ja_kumppanuus1');?></div>
      <div class="box-2" id="box17"><?php get_field('yhteistyo_ja_kumppanuus2');?></div>
    </div>
  </div>
