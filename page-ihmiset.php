...
<section class="hero alignfull wave-bottom bc-keltainen" style="background-image:url('<?= get_the_post_thumbnail_url( $post->ID, 'hero-image' ) ?>'); height: 600px;padding: 0;margin: 0;">
</section>
			</section>
