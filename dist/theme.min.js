...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    var carousel1 = '#sync1';
    var carousel2 = '#sync2'; // Initialize plugin
    ...
    carouselSyncCurrentClass(); // On carousel change: Sync carousel & add current class
