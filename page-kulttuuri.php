...
<div id="primary" class="mt-2 mb-2">
	...
	<section class="hero alignfull" style="background-color: #C2A251;height: 600px;margin: 0;padding: 0;">
<div class="container">
...
<section class="hero alignfull wave-bottom bc-kultainen" style="background-image:url('<?php echo get_the_post_thumbnail_url( $post->ID, 'hero-image' ); ?>'); height: 600px;padding: 0;margin: 0;">
</section>
			</section>
